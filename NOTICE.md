...
Copyright (c) 2026 powerassistant. Source code is licensed under the MIT
License; see `LICENSE`. Safety and liability context is documented in
`DISCLAIMER.md`.
...
No Siemens source manuals, spreadsheets, data dictionaries or product-state screenshots are distributed with this repository.
